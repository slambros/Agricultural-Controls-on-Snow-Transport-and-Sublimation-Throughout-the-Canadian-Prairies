...
T_2m = ncread('C:\users\sarah\Desktop\Project\Files\Downloaded_Data\RH_91_96.nc', 't2m');
Td_2m = ncread('C:\users\sarah\Desktop\Project\Files\Downloaded_Data\RH_91_96.nc', 'd2m');
...
end_days = [year_end_days (year_end_days+365) (year_end_days+2*365)...
 ...
 RH_91_96 = zeros(nlon,nlat,ndays);
...
RH_91_96(k_lon,j_lat,numhrs) = 100*esat_Td(k_lon,j_lat,numhrs)/esat_T(k_lon,j_lat,numhrs);
        end
    end
end
